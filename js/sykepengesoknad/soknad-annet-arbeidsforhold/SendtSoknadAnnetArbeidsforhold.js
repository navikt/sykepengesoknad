...
const SendtSoknadAnnetArbeidsforhold = ({ sykmelding, soknad }) => {
    ...
    return (
        <React.Fragment>
            ...
            {sykmelding && <SykmeldingUtdragForAnnetArbeidsforhold sykmelding={sykmelding} sykepengesoknad={{ _erOppdelt }} />}
...
SendtSoknadAnnetArbeidsforhold.propTypes = {
...
export default connect(mapStateToProps)(SendtSoknadAnnetArbeidsforhold);
