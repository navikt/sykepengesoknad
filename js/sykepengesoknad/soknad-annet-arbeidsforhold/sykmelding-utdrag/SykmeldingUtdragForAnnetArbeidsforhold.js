...
const SykmeldingUtdragForAnnetArbeidsforhold = ({ erApen, sykmelding, erOppdelt }) => {
...
SykmeldingUtdragForAnnetArbeidsforhold.propTypes = {
    erApen: PropTypes.bool,
    erOppdelt: PropTypes.bool,
    sykmelding: sykmeldingPt,
};

export default SykmeldingUtdragForAnnetArbeidsforhold;
