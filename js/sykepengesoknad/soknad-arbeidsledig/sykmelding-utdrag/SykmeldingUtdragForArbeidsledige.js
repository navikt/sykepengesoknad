...
const SykmeldingUtdragForArbeidsledige = ({ erApen, sykmelding, erOppdelt }) => {
...
SykmeldingUtdragForArbeidsledige.propTypes = {
    erApen: PropTypes.bool,
    erOppdelt: PropTypes.bool,
    sykmelding: sykmeldingPt,
};

export default SykmeldingUtdragForArbeidsledige;
